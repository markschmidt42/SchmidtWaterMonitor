...
// our Tank typically starts filling at the 320 mark (180 mark on one of the tanks)
#define TANK_LEVEL_TOO_HIGH_VALUE 330 // give it a 10 gallon buffer before it alerts
